...
Revision ID: 51890c423a60
Revises: 
Create Date: 2018-03-26 11:23:44.712288
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('own', sa.String(length=16), nullable=True),
    sa.Column('platform', sa.String(length=32), nullable=True),
    sa.Column('feature', sa.String(length=32), nullable=True),
    ...
    sa.Column('mem_used_percent', sa.Float(precision=2), nullable=True),
